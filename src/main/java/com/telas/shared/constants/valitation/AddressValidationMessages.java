...
public final class AddressValidationMessages {
    ...
    public static final String COUNTRY_SIZE = "Country size must be less than or equal to 50 characters.";
    public static final String ADDRESS2_SIZE = "Address 2 size must be less than or equal to 100 characters.";
