...
public final class CartValidationMessages {
  ...
  public static final String MAX_QUANTITY_MONITOR_BLOCK = "Maximum quantity of monitor blocks is " + SharedConstants.MAX_CART_ITEM_BLOCK_QUANTITY + ".";
  public static final String PARTNER_OWN_SCREEN_NOT_IN_CART = "Your own screens cannot be added to the cart. Use Upload on the map or My screens.";
  public static final String CART_NO_ELIGIBLE_ITEMS = "No screens could be added to the cart.";
