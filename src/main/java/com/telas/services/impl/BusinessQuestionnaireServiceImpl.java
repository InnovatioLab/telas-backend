...
public class BusinessQuestionnaireServiceImpl implements BusinessQuestionnaireService {
    ...
    private void notifyAdminsQuestionnaireUpdated(Client client, AdRequest adRequest, int version) {
        ...
        base.put("link", clientPortalLinkResolver.adminAdsLink());
        base.put("adRequestId", adRequest.getId().toString());
        adminAdsNotificationService.notifyAdmins(NotificationReference.AD_REQUEST_QUESTIONNAIRE_UPDATED, base);
    }
